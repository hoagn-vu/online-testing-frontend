      ...
      <div className="container-take-exam">
        <div className="content-take-exam">
          <div className="question-take-exam">
            ...
            <p>
              Who was the first female Prime Minister of the United Kingdom?Who
              was the first female Prime Minister of the United Kingdom?Who was
              the first female Prime Minister of the United Kingdom?Who was the
              first female Prime Minister of the United Kingdom?
            </p>
            <ul className="options-take-exam"></ul>
          </div>
          <div className="question-take-exam">
            <div className="header-question-take-exam">
